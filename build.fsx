...
Target "AssemblyInfo" (fun _ ->
    XmlPokeInnerText "./src/Akka.DI.StructureMap/Akka.DI.StructureMap.csproj" "//Project/PropertyGroup/VersionPrefix" releaseNotes.AssemblyVersion    
    XmlPokeInnerText "./src/Akka.DI.StructureMap/Akka.DI.StructureMap.csproj" "//Project/PropertyGroup/PackageReleaseNotes" (releaseNotes.Notes |> String.concat "\n")
)
